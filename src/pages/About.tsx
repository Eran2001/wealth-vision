    ...
    <>
      ...
      <section className="container py-16">
        <div className="max-w-5xl mx-auto">
          <div className="mb-10">
            <h2 className="font-display text-2xl md:text-3xl font-semibold">Team Members</h2>
          ...
          <div className="mb-10">
            <h2 className="font-display text-2xl md:text-3xl font-semibold">Supervisors</h2>
            <p className="mt-2 text-muted-foreground">
